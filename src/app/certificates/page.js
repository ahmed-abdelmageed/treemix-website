    ...
    <>
      <div className="mb-14">
        ...
        <div className="flex justify-center flex-col items-center gap-3 mb-8 mt-12 certificate-desc px-12">
          ...
          >
            At Tree Mix, we take pride in providing only the highest quality
            herbal products. Our certifications reflect our commitment to
            excellence, ensuring that all our herbs are organically grown,
            sustainably sourced, and meet rigorous safety and quality standards.
            These certifications guarantee that you can trust TreeMix for pure,
            natural, and eco-friendly herbal solutions.{" "}
          </motion.p>
        </div>
                  ...
                  <div className="flex justify-between items-center w-full mt-5">
                    ...
                    <div className="flex items-center mx- gap-4 mr-2">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          handlePreview(certificate.pdf, certificate.name)
                        }
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          handleDownload(certificate.pdf, certificate.name)
                        }
