        ...
        <div className="about-container">
            ...
            >
                <div className="content w-full lg:w-1/2  sm:mx-6 md:mx-8 lg:mx-12 xl:mx-8">
                    ...
                    >
                        <span className="maincolor font-bold">Tree Mix</span>{" "}
                        believes in the power of nature to promote well-being.
                        Our premium organic herbs are sourced from trusted farms
                        and cultivated with care. With a commitment to quality,
                        sustainability, and trust, we bring the finest herbal
                        solutions.
                    </motion.p>
                </div>
            ...
            <div className="section our-history mx-4 sm:mx-6 md:mx-8 lg:mx-12 xl:mx-16 mb-8">
                <div className="content mx-4 sm:mx-6 md:mx-8 lg:mx-12 xl:mx-16">
                    ...
                    <p className="section-text">
                        Tree Mix is a company that specializes in the export and
                        import of both organic and conventional crops, including
                        herbs, spices, and seeds. Established in 1980, we
                        initially focused on local trading of herbs and spices,
                        but since 2000, we have expanded our operations to
                        include global exports of our products and we take pride
                        in holding certifications such as Organic, USDA NOP,
                        HACCP, ISO, and Fairtrade.
                    </p>
                    <p className="section-text">
                        Our commitment to providing processed products of the
                        highest quality is unwavering and to ensure consistent
                        standards, we work with approved raw material suppliers
                        and meticulously process each product in accordance with
                        your company’s specific requirements, guaranteeing that
                        all herbs and spices meet the desired specifications.
                    </p>
                    <p className="section-text">
                        At Tree Mix , we strive to enhance your business by
                        delivering exceptional agricultural products that meet
                        your needs.
                    </p>
            ...
            <div className="section success-story w-full mb-14">
                <div className="image-container mb-10 sm:mb-12 md:mb-14">
                    <div className="success-story-wrapper">
                        ...
                        <div className="success-story-title flex items-center justify-center mt-8 sm:mt-10 md:mt-12 text-lg sm:text-xl md:text-2xl">
                            <span>🌿</span>
                            <span className="mx-2">Our Success Story</span>
                            <span>🌿</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="our-success-head mx-4 sm:mx-6 md:mx-8 lg:mx-12 xl:mx-16">
                    <p className="text-sm sm:text-base md:text-lg leading-relaxed">
                        <strong className="maincolor font-bold">
                            Tree Mix
                        </strong>{" "}
                        was established in 1980, We are a reliable supplier of
                        herbs, spices, and seeds all compliant with EU
                        regulations. We have an experienced and professional
                        team working hard to ensure the best quality, ensuring
                        that our product always meets your requirements.
                    </p>
                </div>
                    ...
                    <div className="content w-full lg:w-1/2 flex flex-col justify-center">
                        ...
                        <p className="section-text text-sm sm:text-base md:text-lg leading-relaxed">
                            ...
                            <strong className="maincolor font-semibold mx-1">
                                ...
                                Ireland, New Zealand, Portugal, Sri Lanka,
                                Tunisia, the UK, etc.)
                            </strong>
                            We have an experienced and professional team working
                            hard to ensure the best quality.
                        </p>
                    </div>
